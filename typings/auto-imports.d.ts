...
declare global {
  ...
  const UserAddressModel: typeof import('../src/models/user')['UserAddressModel']
...
declare global {
  ...
  // @ts-ignore
  export type { UserModel, UserAdminModel, UserRoleModel, UserAddressModel } from '../src/models/user'
