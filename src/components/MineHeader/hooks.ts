      ...
      children: [
        {
          ...
          shortcut: 'Ctrl + G',
          action() {
            ipcRenderer.invoke('open', 'https://gitee.com/biaovorg/project-template/tree/electron/') // 渲染进程
          }
        },
        {
          label: '提问题',
          ...
          shortcut: 'Ctrl + I',
          action() {
            ipcRenderer.invoke('open', 'https://gitee.com/biaovorg/project-template/issues') // 渲染进程
          }
        },
        {
          label: '检查更新',
