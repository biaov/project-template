...
<template>
  ...
  <header class="mine-header" @contextmenu.prevent="onContextmenu" @mousedown="onMousedown">
    <div class="lf">
      <!-- logo -->
      <div class="logo">
        <img src="../../assets/logo.svg" alt="图片" mode="contain" title="project-template" />
      </div>
      <!-- 菜单 -->
    ...
    <div class="center">PROJECT-TEMPLATE [biaov]</div>
    <!-- 设置大小 -->
  ...
  <a-drawer v-model:open="aboutDrawer.visible" title="关于" placement="bottom" :closable="false">
    <a-descriptions title="" bordered>
      ...
      <a-descriptions-item label="版权">Copyright (c) 2023-present biaov</a-descriptions-item>
    </a-descriptions>
  </a-drawer>
